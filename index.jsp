...
<body>
    <h4 class="form-title pt-5"><b>SAI KRISHNA SWEETS & BAKERY ,MADHIRA</b></h4>
    		...
    		<h4 class="form-title">Create Account</h4>
   			  ...
   			  <form name="registration" method="post" action="CustomerController" class="form-group">
						<div class="row pt-2">
							<div class="col-md-12">
						...
						<div class="row pt-2">
							...
							<div class="col-md-8">
								...
								<a href="login.jsp" type="button" class="btn btn-success btn-block " >Login</a>
							</div>
						</div>
						
						<div class="row pt-2">
							<div class="col-md-12">
								<a href="delete.jsp" type="button" class="btn btn-danger btn-block" >Delete Account</a>
							</div>
						</div>
				</form>
 			 </div>
